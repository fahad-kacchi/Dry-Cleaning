...
<%
	...
	try{
		...
		if(listOfRates != null){
			...
			rateString = ""+
						"<tr>"+
							"<td scope=\"col\">"+listOfRates.get(0)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(1)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(2)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(3)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(4)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(5)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(6)+"</td>"+
							"<td scope=\"col\">"+listOfRates.get(7)+"</td>"+
						"</tr>";
